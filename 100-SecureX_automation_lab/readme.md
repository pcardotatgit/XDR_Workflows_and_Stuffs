...
5. If you used the simulator GUI to edit the **config.py** file, you will have to stop and restart the simulator in order to make changes to be taken in account.
