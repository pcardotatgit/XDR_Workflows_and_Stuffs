...
* Step 10 : Import useful/relevant XDR/SecureX Workflows from the workflow lists
...
* 6 - Manage SecureX Blocking Lists ( SecureX Feeds )
    ...
    * 6f - [ Create a SecureX IP blocking list from TOR entry / exit IP address Blocking List](https://github.com/pcardotatgit/SecureX_Workflows_and_Stuffs/tree/master/500-SecureX_Workflow_examples/Workflows/TOP_IP_blocking_list_to_SecureX_feeds) : the final workflow
